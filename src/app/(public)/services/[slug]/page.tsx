...
export default async function ServicePage({ params }: { params: { slug: string } }) {
  ...
  return <div className="min-h-screen bg-white text-navy"><Navbar /><main className="pt-[72px]">
    ...
    <section className="py-24"><div className="max-w-[900px] mx-auto px-6 lg:px-8 text-center"><p className="text-[13px] font-bold tracking-[0.2em] text-coral uppercase mb-3">Ready when you are</p><h2 className="text-[38px] sm:text-[52px] font-black tracking-tight leading-tight">Let&apos;s build something that moves your business forward.</h2><ServiceProjectCTASecondary serviceName={service.title} /></div></section>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <a href="/admin/clients/new" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-teal hover:bg-teal/5 transition group">
            ...
            <a href="/admin/projects/new" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:border-coral hover:bg-coral/5 transition group">
